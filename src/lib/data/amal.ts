...
export const ALL_AMAL: Amal[] = [
  ...
  },
  {
    ...
    detail: "৯ জিলহজ ফজর থেকে ১০ জিলহজ আসর পর্যন্ত প্রতিটি ফরজ নামাজের পর তাকবীরে তাশরীক পড়া ওয়াজিব।",
  },
  ...
  },
  {
    ...
    detail: "কুরবানি একটি মহান ইবাদত। সামর্থ্যবান ব্যক্তির উপর ওয়াজিব। ১০ জিলহজ ঈদের নামাজের পর কুরবানি করুন।",
  },
  {
    id: "eid_path_change",
